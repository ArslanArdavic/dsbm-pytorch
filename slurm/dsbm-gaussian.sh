...
#SBATCH --job-name=dsbm-gaussian
#SBATCH --output=slurm/log/dsbm_gaussian_%j.out
#SBATCH --error=slurm/log/dsbm_gaussian_%j.err
#SBATCH --nodes=1
...
srun singularity run -B /scratch/project_465002822,/project/project_465002822 $SIF bash -c \
    'python ./DSBM-Gaussian.py dim=5 model_name=dsbm first_coupling=ind seed=1 inner_iters=10000 -m'
